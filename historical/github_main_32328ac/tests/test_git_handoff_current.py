...
class GitHandoffCurrentTests(unittest.TestCase):
    ...
    def test_manifest_top_level_metadata_tracks_v11_source_successor(self) -> None:
        ...
        self.assertIn("HOSTED_CI_PARTIAL", self.manifest["current_source_qualification"])
        self.assertIn("Ubuntu SUCCESS", self.manifest["current_source_qualification"])
        self.assertIn("Windows FAILURE", self.manifest["current_source_qualification"])

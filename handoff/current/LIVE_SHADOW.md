...
- Idempotency + async compatibility + bounded health are engineering-published and live-promoted; Windows Job Object resource envelope is the next server campaign.
- Final schema remains last/untriggered.
- Do not live-promote unless separately authorized/gated.

## Immediate Next Step
- Begin Windows Job Object resource-envelope campaign; OBE/Skills dogfood may proceed against the live promoted Runtime in parallel.

...
35. **Compact-count parity is not membership derivation.** The current 30-operation transport projection is curated and strongly parity-tested. A future compositional schema must declare/derive eligibility before automatic membership selection.
...
37. **Core Runtime closure does not pre-complete the final schema.** Present durable truth/authority/execution architecture can be converged while effect algebra, compositional planning and final adapter schema remain a separately gated campaign.
